  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6">
      <div className="text-center mb-6">
        ...
        <p className="text-blue-600">Corporate Lawyer</p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center">
          ...
          <div>
            ...
            <p className="text-gray-900">456 Law St, New York, NY 10001</p>
          </div>
        </div>
        <div className="flex items-center">
        ...
        <div className="flex items-center">
          ...
          <div>
            ...
            <p className="text-gray-900">Corporate Law, Mergers & Acquisitions</p>
          </div>
        </div>
      </div>
